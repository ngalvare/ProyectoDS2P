 ...
 * @author ANA
 */
public class ViewSeleccionarBodega extends javax.swing.JFrame {

    /**
     * Creates new form ViewVendedor
     */
    public ViewSeleccionarBodega() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        buttonVentaPresencial.setText("Seleccionar");
        ...
        jLabel1.setText("SELECCIONAR BODEGA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSeleccionarBodega.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSeleccionarBodega().setVisible(true);
            }
        });
    }
