 ...
 * @author ANA
 */
public class ViewSeleccionarEnvio extends javax.swing.JFrame {

    /**
     * Creates new form ViewVendedor
     */
    public ViewSeleccionarEnvio() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSeleccionarEnvio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSeleccionarEnvio().setVisible(true);
            }
        });
    }
