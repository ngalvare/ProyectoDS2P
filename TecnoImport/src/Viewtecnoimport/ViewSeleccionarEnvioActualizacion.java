 ...
 * @author ANA
 */
public class ViewSeleccionarEnvioActualizacion extends javax.swing.JFrame {

    /**
     * Creates new form ViewVendedor
     */
    public ViewSeleccionarEnvioActualizacion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        buttonSeleccionar.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jLabel1.setText("SELECCIONAR ENVIO");
    ...
    private void buttonSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSeleccionarActionPerformed
        ...
        ViewActualizarEnvio v = new ViewActualizarEnvio();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSeleccionarEnvioActualizacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSeleccionarEnvioActualizacion().setVisible(true);
            }
        });
    }
