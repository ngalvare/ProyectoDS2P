 ...
 * @author ANA
 */
public class ViewSeleccionarCliente extends javax.swing.JFrame {

    /**
     * Creates new form ViewVendedor
     */
    public ViewSeleccionarCliente() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSeleccionarCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSeleccionarCliente().setVisible(true);
            }
        });
    }
